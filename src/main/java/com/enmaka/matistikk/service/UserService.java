 ...
 * @author Team ENMAKA
 * 
 * Klassen definerer metodene som må implementeres for at kommunikasjon mellom controllerne og repository-klassen skal fungere.
 * Hvis man vil benytte seg av en annen klasse enn UserServiceImpl til å sende informasjon til controllerne, må denne klassen implementeres.
 * 
 * For mer informasjon om klassen, se designdokumentet kapittel 4.9.1.
 */
