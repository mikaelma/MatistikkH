...
<html lang="no">
    ...
    <body onload="init()">
            ...
            <form:form action="nexttask" method="POST" modelAttribute="test">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        Svar:
                        <br>
                        <input type="number" id="numerator" placeholder="Teller" value="${test.currentTask.answer.value.numerator}" autofocus required> /
                        <input type="number" id="denominator" placeholder="Nevner" value="${test.currentTask.answer.value.denominator}" required>
                        <hr>
                        Begrunnelse:
        ...
        <script type="text/javascript">
            ...
            function setAnswer(){
                document.getElementById("hidden1").value = document.getElementById("numerator").value + "/" + document.getElementById("denominator").value;
            }
